...
export const iconboxVariants = cva('shrink-0', {
  variants: {
    color: {
      default: '',
      contrast: '',
  ...
  compoundVariants: [
    ...
    },
    {
      ...
      color: 'primary',
      className:
        'bg-primary-100 dark:bg-primary-900 dark:hover:bg-primary-800 text-primary-500 hover:text-white hover:bg-primary-500 duration-200 transition-colors'
    },
    {
      variant: 'pastel',
      color: 'info',
